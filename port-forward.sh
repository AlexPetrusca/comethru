...
pkill -f "kubectl port-forward svc/comethru-mocker"
...
kubectl port-forward svc/comethru-mocker 8099:8099 8098:8098 &
kubectl port-forward svc/comethru-prometheus-server 9090:80 &
kubectl port-forward svc/comethru-grafana 9091:80